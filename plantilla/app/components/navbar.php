  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#">Sitio <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Clientes</a>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="menu_paquetes" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Comencemos
        </a>
        <div class="dropdown-menu" aria-labelledby="menu_paquetesk">
